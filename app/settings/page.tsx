        ...
        <PageLayout title="Settings">
            <div className="flex-1 p-6 pb-4 overflow-y-auto">
                <div className="space-y-6">
                    ...
                    <section>
                        <h3 className="text-sm font-bold text-neutral-400 uppercase tracking-wider mb-4">Data Management</h3>
                        <button
                            onClick={handleClear}
                            className="w-full bg-red-50 text-red-600 rounded-xl p-4 flex items-center gap-3 font-medium hover:bg-red-100 transition-colors"
                        >
                            <Trash2 size={20} />
